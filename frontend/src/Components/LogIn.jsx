...
export default function Login() {
  ...
  return (
    <div className="relative flex items-center justify-center w-full overflow-hidden font-sans">
      {}
      <div className="relative w-full max-w-sm p-6 space-y-6 bg-white border rounded-lg shadow-lg dark:bg-black border-zinc-200 dark:border-zinc-800 dark:shadow-zinc-900/50">
        ...
        {/* <div className="grid grid-cols-3 gap-2">
                {[{
                    ...
                    icon: <XIcon />
                }].map((item, index) => <button key={index} className="flex items-center justify-center px-3 transition-colors bg-white border rounded-md h-9 border-zinc-200 dark:border-zinc-800 dark:bg-black hover:bg-zinc-50 dark:hover:bg-zinc-900 hover:text-zinc-900 dark:hover:text-zinc-50 focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-zinc-950 dark:focus-visible:ring-zinc-300">
                    {item.icon}
                </button>)}
            </div> */}
        ...
        <div className="space-y-2 text-center">
          ...
          {/* <a href="#" className="text-sm font-medium underline transition-colors text-zinc-900 dark:text-zinc-50 underline-offset-4 hover:text-zinc-700 dark:hover:text-zinc-300">
